...
export interface SettingsDefaults {
  ...
  CLAUDE_MEM_GEMINI_AUTH_METHOD: string;  // 'cli' | 'api_key' - how Gemini provider authenticates
...
export class SettingsDefaultsManager {
  ...
  private static readonly DEFAULTS: SettingsDefaults = {
    ...
    CLAUDE_MEM_GEMINI_AUTH_METHOD: 'api_key',  // Default to API key (backward compatible). 'cli' uses gemini CLI binary
